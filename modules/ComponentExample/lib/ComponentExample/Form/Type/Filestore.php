 ...
 * Time: 18:40
 */
namespace ComponentExample\Form\Type;

use ComponentExample\Form\Type;

class Filestore extends Type
{

    public function render($fieldName) {
        $html = '<div class="AttachmentUploaderContainer"><button type="button" class="btn btn-default AddAttachmentBtn">'.vtranslate('Add Attachment', 'ComponentExample').'</button>';
