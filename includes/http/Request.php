...
class Vtiger_Request {
	...
	/**
	 * Get key value of parameter
     * If parameter not exist, return default value
     *
     *
     * ```php
     * // This return empty string, when parameter not existing
     * $request->get('parametername');
     *
     * // This return 'default' string, when parameter not existing
     * $request->get('parametername', 'default');
     * ```
     *
     *
	 */
